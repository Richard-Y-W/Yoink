...
export default function IOSDevice({ children, width = 402, height = 874 }) {
  ...
  if (frameless) {
    return (
      <div className="yoink-native-viewport" style={{
        width: '100%', minHeight: '100dvh', height: '100dvh', overflow: 'visible',
  ...
  return (
    <div style={{
      ...
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        <div className="ynoscroll" style={{ flex: 1, overflow: 'auto' }}>{children}</div>
      </div>
