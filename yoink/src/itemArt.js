...
export const ITEM_ART = {
  ...
  crt: {
    hue: 'purple', hue2: 'teal', bg: 'coral',
    sil: [
      { t: 'rect', x: 48, y: 14, w: 5, h: 28, rx: 2.5, transform: 'rotate(-28 50 28)' },
      { t: 'rect', x: 87, y: 14, w: 5, h: 28, rx: 2.5, transform: 'rotate(28 90 28)' },
      { t: 'rect', x: 34, y: 38, w: 72, h: 54, rx: 11 },
      { t: 'rect', x: 44, y: 90, w: 10, h: 8, rx: 3 },
      { t: 'rect', x: 86, y: 90, w: 10, h: 8, rx: 3 },
    ],
    details: [
      { t: 'rect', x: 42, y: 46, w: 44, h: 38, rx: 6, fill: 'ink' },
      { t: 'rect', x: 46, y: 50, w: 36, h: 30, rx: 4, fill: 'accent' },
      { t: 'circle', cx: 58, cy: 62, r: 2.6, fill: 'white' },
      { t: 'circle', cx: 72, cy: 62, r: 2.6, fill: 'white' },
      { t: 'path', d: 'M58 70 q7 5 14 0', stroke: 'white', sw: 2.5, fill: 'none' },
      { t: 'circle', cx: 96, cy: 54, r: 4, fill: 'deep' },
      { t: 'circle', cx: 96, cy: 66, r: 4, fill: 'deep' },
      { t: 'rect', x: 91, y: 75, w: 10, h: 2.5, rx: 1.25, fill: 'ink', opacity: 0.45 },
      { t: 'rect', x: 91, y: 80, w: 10, h: 2.5, rx: 1.25, fill: 'ink', opacity: 0.45 },
      { t: 'circle', cx: 43, cy: 15, r: 3.5, fill: 'accent' },
      { t: 'circle', cx: 97, cy: 15, r: 3.5, fill: 'blush' },
    ],
    spec: [{ cx: 48, cy: 43, rx: 9, ry: 4, rot: -12 }],
  },
  furby: {
    hue: 'purple', hue2: 'coral', bg: 'yellow',
    sil: [
      { t: 'ellipse', cx: 50, cy: 36, rx: 8, ry: 13, transform: 'rotate(-18 50 36)' },
      { t: 'ellipse', cx: 90, cy: 36, rx: 8, ry: 13, transform: 'rotate(18 90 36)' },
      { t: 'ellipse', cx: 70, cy: 66, rx: 30, ry: 32 },
      { t: 'ellipse', cx: 56, cy: 98, rx: 10, ry: 5 },
      { t: 'ellipse', cx: 84, cy: 98, rx: 10, ry: 5 },
    ],
    details: [
      { t: 'ellipse', cx: 50, cy: 38, rx: 4, ry: 7, transform: 'rotate(-18 50 38)', fill: 'blush' },
      { t: 'ellipse', cx: 90, cy: 38, rx: 4, ry: 7, transform: 'rotate(18 90 38)', fill: 'blush' },
      { t: 'ellipse', cx: 70, cy: 74, rx: 17, ry: 17, fill: 'white' },
      { t: 'circle', cx: 61, cy: 54, r: 7, fill: 'white' },
      { t: 'circle', cx: 79, cy: 54, r: 7, fill: 'white' },
      { t: 'circle', cx: 62, cy: 55, r: 3.2, fill: 'ink' },
      { t: 'circle', cx: 78, cy: 55, r: 3.2, fill: 'ink' },
      { t: 'circle', cx: 63.2, cy: 53.8, r: 1.1, fill: 'white' },
      { t: 'circle', cx: 79.2, cy: 53.8, r: 1.1, fill: 'white' },
      { t: 'path', d: 'M64 64 h12 l-6 8 z', fill: 'accent', outline: true },
      { t: 'ellipse', cx: 70, cy: 34, rx: 5, ry: 7, fill: 'shade' },
    ],
    spec: [{ cx: 56, cy: 46, rx: 9, ry: 6, rot: -22 }],
  },
  pager: {
    hue: 'blue', hue2: 'yellow', bg: 'pink',
    sil: [
      { t: 'rect', x: 58, y: 46, w: 24, h: 12, rx: 5 },
      { t: 'rect', x: 38, y: 54, w: 64, h: 40, rx: 10 },
    ],
    details: [
      { t: 'rect', x: 62, y: 49, w: 16, h: 3, rx: 1.5, fill: 'light' },
      { t: 'rect', x: 46, y: 62, w: 34, h: 22, rx: 4, fill: 'white' },
      { t: 'rect', x: 50, y: 68, w: 20, h: 3.5, rx: 1.75, fill: 'deep' },
      { t: 'rect', x: 50, y: 75, w: 13, h: 3.5, rx: 1.75, fill: 'shade' },
      { t: 'circle', cx: 91, cy: 67, r: 4, fill: 'accent' },
      { t: 'circle', cx: 91, cy: 79, r: 4, fill: 'ink', opacity: 0.4 },
      { t: 'path', d: 'M106 50 q6 6 0 12', stroke: 'accent', sw: 2.5, fill: 'none' },
      { t: 'path', d: 'M112 45 q10 11 0 22', stroke: 'accent', sw: 2.5, fill: 'none' },
    ],
    spec: [{ cx: 48, cy: 58, rx: 9, ry: 3.5, rot: -10 }],
  },
  snowglobe: {
    hue: 'blue', hue2: 'pink', bg: 'purple',
    sil: [
      { t: 'circle', cx: 70, cy: 54, r: 28 },
      { t: 'path', d: 'M48 78 h44 l5 18 h-54 z' },
    ],
    details: [
      { t: 'ellipse', cx: 70, cy: 66, rx: 20, ry: 6, fill: 'deep', opacity: 0.3 },
      { t: 'circle', cx: 70, cy: 58, r: 8, fill: 'white' },
      { t: 'circle', cx: 70, cy: 45, r: 5.5, fill: 'white' },
      { t: 'circle', cx: 68, cy: 44, r: 1.1, fill: 'ink' },
      { t: 'circle', cx: 72, cy: 44, r: 1.1, fill: 'ink' },
      { t: 'path', d: 'M70 46 l7 1 -7 2.5 z', fill: 'accent' },
      { t: 'circle', cx: 55, cy: 40, r: 1.8, fill: 'white', opacity: 0.9 },
      { t: 'circle', cx: 84, cy: 36, r: 1.6, fill: 'white', opacity: 0.9 },
      { t: 'circle', cx: 88, cy: 52, r: 1.8, fill: 'white', opacity: 0.9 },
      { t: 'circle', cx: 54, cy: 58, r: 1.5, fill: 'white', opacity: 0.9 },
      { t: 'rect', x: 50, y: 82, w: 40, h: 4.5, rx: 2.25, fill: 'accent' },
    ],
    spec: [{ cx: 57, cy: 38, rx: 8, ry: 6, rot: -28 }],
  },
  cassette: {
    hue: 'coral', hue2: 'purple', bg: 'blue',
    sil: [{ t: 'rect', x: 36, y: 44, w: 68, h: 44, rx: 7 }],
    details: [
      { t: 'rect', x: 42, y: 50, w: 56, h: 13, rx: 3, fill: 'white' },
      { t: 'path', d: 'M46 56.5 q9 3 18 0 q9 -2.5 18 .5', stroke: 'accent', sw: 2, fill: 'none' },
      { t: 'rect', x: 48, y: 67, w: 44, h: 13, rx: 6.5, fill: 'ink' },
      { t: 'circle', cx: 59, cy: 73.5, r: 4.2, fill: 'white' },
      { t: 'circle', cx: 81, cy: 73.5, r: 4.2, fill: 'white' },
      { t: 'rect', x: 63, y: 72, w: 14, h: 3, fill: '#5C5480' },
      { t: 'circle', cx: 41.5, cy: 84, r: 1.6, fill: 'ink', opacity: 0.5 },
      { t: 'circle', cx: 98.5, cy: 84, r: 1.6, fill: 'ink', opacity: 0.5 },
      { t: 'path', d: 'M60 88 l3 -5 h14 l3 5 z', fill: 'shade' },
    ],
    spec: [{ cx: 48, cy: 48, rx: 9, ry: 3.4, rot: -8 }],
  },
  skate: {
    hue: 'pink', hue2: 'teal', bg: 'purple',
    sil: [
      { t: 'rect', x: 44, y: 26, w: 26, h: 38, rx: 9 },
      { t: 'rect', x: 44, y: 50, w: 54, h: 32, rx: 12 },
      { t: 'circle', cx: 96, cy: 70, r: 12 },
      { t: 'circle', cx: 58, cy: 88, r: 8 },
      { t: 'circle', cx: 84, cy: 88, r: 8 },
    ],
    details: [
      { t: 'rect', x: 44, y: 62, w: 48, h: 7, fill: 'white', opacity: 0.75 },
      { t: 'path', d: 'M50 33 l14 6 M64 33 l-14 6 M50 40 l14 6 M64 40 l-14 6', stroke: 'white', sw: 2.2, fill: 'none' },
      { t: 'circle', cx: 96, cy: 66, r: 4, fill: 'white', opacity: 0.7 },
      { t: 'circle', cx: 58, cy: 88, r: 4.5, fill: 'accent' },
      { t: 'circle', cx: 84, cy: 88, r: 4.5, fill: 'accent' },
      { t: 'circle', cx: 58, cy: 88, r: 1.6, fill: 'white' },
      { t: 'circle', cx: 84, cy: 88, r: 1.6, fill: 'white' },
      { t: 'circle', cx: 103, cy: 79, r: 4, fill: 'accent' },
    ],
    spec: [{ cx: 52, cy: 32, rx: 6, ry: 4, rot: -18 }],
  },
  cube: {
    hue: 'white', hue2: 'purple', bg: 'pink',
    sil: [{ t: 'rect', x: 44, y: 38, w: 52, h: 52, rx: 10 }],
    details: [
      { t: 'rect', x: 50, y: 44, w: 12, h: 12, rx: 3, fill: '#FF6B3D' },
      { t: 'rect', x: 64, y: 44, w: 12, h: 12, rx: 3, fill: '#FFE177' },
      { t: 'rect', x: 78, y: 44, w: 12, h: 12, rx: 3, fill: '#10B5A0' },
      { t: 'rect', x: 50, y: 58, w: 12, h: 12, rx: 3, fill: '#3B82F6' },
      { t: 'rect', x: 64, y: 58, w: 12, h: 12, rx: 3, fill: '#FF3D9A' },
      { t: 'rect', x: 78, y: 58, w: 12, h: 12, rx: 3, fill: '#FFE177' },
      { t: 'rect', x: 50, y: 72, w: 12, h: 12, rx: 3, fill: '#10B5A0' },
      { t: 'rect', x: 64, y: 72, w: 12, h: 12, rx: 3, fill: '#8B5CF6' },
      { t: 'rect', x: 78, y: 72, w: 12, h: 12, rx: 3, fill: '#FF6B3D' },
    ],
    spec: [{ cx: 52, cy: 42, rx: 8, ry: 3.6, rot: -14 }],
  },
  butterfly: {
    hue: 'purple', hue2: 'pink', bg: 'teal',
    sil: [
      { t: 'ellipse', cx: 52, cy: 50, rx: 17, ry: 21, transform: 'rotate(-22 52 50)' },
      { t: 'ellipse', cx: 88, cy: 50, rx: 17, ry: 21, transform: 'rotate(22 88 50)' },
      { t: 'ellipse', cx: 57, cy: 79, rx: 12, ry: 14, transform: 'rotate(18 57 79)' },
      { t: 'ellipse', cx: 83, cy: 79, rx: 12, ry: 14, transform: 'rotate(-18 83 79)' },
      { t: 'ellipse', cx: 70, cy: 64, rx: 6.5, ry: 23 },
    ],
    details: [
      { t: 'circle', cx: 50, cy: 47, r: 6, fill: 'accent' },
      { t: 'circle', cx: 90, cy: 47, r: 6, fill: 'accent' },
      { t: 'circle', cx: 57, cy: 79, r: 4, fill: 'white', opacity: 0.85 },
      { t: 'circle', cx: 83, cy: 79, r: 4, fill: 'white', opacity: 0.85 },
      { t: 'path', d: 'M66 44 q-4 -9 -10 -12 M74 44 q4 -9 10 -12', stroke: 'ink', sw: 2, fill: 'none' },
      { t: 'circle', cx: 56, cy: 31, r: 2.2, fill: 'accent' },
      { t: 'circle', cx: 84, cy: 31, r: 2.2, fill: 'accent' },
      { t: 'circle', cx: 67.5, cy: 55, r: 1.8, fill: 'ink' },
      { t: 'circle', cx: 72.5, cy: 55, r: 1.8, fill: 'ink' },
      { t: 'path', d: 'M67 60 q3 2.5 6 0', stroke: 'ink', sw: 1.8, fill: 'none' },
    ],
    spec: [{ cx: 47, cy: 40, rx: 7, ry: 5, rot: -30 }],
  },
  yoyo: {
    hue: 'teal', hue2: 'pink', bg: 'coral',
    sil: [{ t: 'circle', cx: 70, cy: 66, r: 28 }],
    details: [
      { t: 'circle', cx: 70, cy: 66, r: 19, fill: 'none', stroke: 'light', sw: 3 },
      { t: 'circle', cx: 70, cy: 66, r: 7.5, fill: 'white' },
      { t: 'circle', cx: 70, cy: 66, r: 3, fill: 'accent' },
      { t: 'path', d: 'M68 39 q-6 -16 -24 -13', stroke: 'ink', sw: 2.5, fill: 'none' },
      { t: 'circle', cx: 40, cy: 27, r: 5, fill: 'none', stroke: 'ink', sw: 2.5 },
      { t: 'path', d: 'M85 52 l1.8 3.8 4.2 .6 -3 3 .7 4.2 -3.7 -2 -3.7 2 .7 -4.2 -3 -3 4.2 -.6 z', fill: 'accent', opacity: 0.9 },
    ],
    spec: [{ cx: 54, cy: 49, rx: 8, ry: 5, rot: -28 }],
  },
  disco: {
    hue: 'white', hue2: 'purple', bg: 'pink',
    sil: [
      { t: 'rect', x: 66, y: 24, w: 8, h: 14, rx: 3 },
      { t: 'circle', cx: 70, cy: 64, r: 28 },
    ],
    details: [
      { t: 'path', d: 'M45 52 h50 M42 64 h56 M45 76 h50', stroke: 'shade', sw: 2, fill: 'none' },
      { t: 'path', d: 'M70 36 v56 M56 38.5 q-7 25 0 51 M84 38.5 q7 25 0 51', stroke: 'shade', sw: 2, fill: 'none' },
      { t: 'rect', x: 60, y: 55, w: 7, h: 7, rx: 1.5, fill: '#D6C2FF' },
      { t: 'rect', x: 75, y: 67, w: 7, h: 7, rx: 1.5, fill: '#FFB9DC' },
      { t: 'rect', x: 49, y: 66, w: 6, h: 6, rx: 1.5, fill: '#A6EEDD' },
      { t: 'rect', x: 74, y: 43, w: 6, h: 6, rx: 1.5, fill: '#FFE177' },
      { t: 'circle', cx: 70, cy: 20, r: 4.5, fill: 'none', stroke: 'accent', sw: 3 },
      { t: 'path', d: 'M104 38 l1.6 4.4 4.4 1.6 -4.4 1.6 -1.6 4.4 -1.6 -4.4 -4.4 -1.6 4.4 -1.6 z', fill: 'accent' },
      { t: 'path', d: 'M34 52 l1.3 3.5 3.5 1.3 -3.5 1.3 -1.3 3.5 -1.3 -3.5 -3.5 -1.3 3.5 -1.3 z', fill: 'blush' },
    ],
    spec: [{ cx: 58, cy: 46, rx: 9, ry: 6, rot: -24 }],
  },
};
